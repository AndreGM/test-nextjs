...
import { updateProduct } from "@/http/updateProduct";
...
export default function UpdateProductForm({ product, onSuccess, onCancel }: UpdateProductFormProps) {
    ...
    const mutation = useMutation({
        mutationFn: (productData: Product) => updateProduct(productData.id, productData),
        onSuccess: () => {
    ...
    // Update form values if product prop changes
    useEffect(() => {
        form.reset({
            id: product.id,
            title: product.title,
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="flex gap-4 justify-end">
                    ...
                    <Button type="submit" className="bg-blue-800 text-white" disabled={mutation.isPending}>
